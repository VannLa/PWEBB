    ...
    <form action="{{ route('surat.store') }}" method="POST">
        ...
        <div class="card-body">
            <div class="form-group mb-3">
                ...
                <input type="text" name="nomor_surat" class="form-control" id="nomor_surat" value="{{ old('nomor_surat') }}" placeholder="Contoh: 005/SKTM/2026" required>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <select name="penduduk_id" class="form-control" id="penduduk_id" required>
            ...
            <div class="form-group mb-3">
                ...
                <input type="date" name="tanggal_ajuan" class="form-control" id="tanggal_ajuan" value="{{ date('Y-m-d') }}" required>
            </div>
        </div>
